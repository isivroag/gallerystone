  ...
  $("#formMov").submit(function (e) {
    ...
    if (idreg.length == 0 || folio.length == 0) {
      ...
      swal
        .fire({
          title: "Corte",
          text: "Este movimiento cambia las Existencias totales del Producto por la cantidad establecida sin importar los movimientos anteriores ¿Desea Continuar?",
            ...
            success: function (data) {
              if (data == 1) {
                Swal.fire({
                  ...
                  text: "No es posible guardar, debe  aplicar movimiento a todos los materiales, revise sus datos",
                  icon: "error",
                });
              } else {
