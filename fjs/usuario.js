$(document).ready(function () {
    ...
    columnDefs: [
      {
        ...
        data: null,
        defaultContent:
          "<div class='text-center'><div class='btn-group'><button class='btn btn-sm btn-primary  btnEditar'><i class='fas fa-edit'></i>\
          </button><button class='btn btn-sm btn-danger btnBorrar'><i class='fas fa-trash-alt'></i></button></div></div>",
      },
  ...
  $(document).on("click", ".btnBorrar", function () {
    ...
    swal
      .fire({
        title: "¿Desea Elmintar el usuario?",
