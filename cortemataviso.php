                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <h2>
                                    ...
                                    Antes de ingresar al módulo de corte de material, ten en cuenta lo siguiente:<br><br>

                                    Este módulo realizará automáticamente un proceso para guardar las medidas y cantidades actuales de todos los materiales en inventario.
...
<script src="fjs/cortemataviso.js?v=<?php echo (rand()); ?>"></script>
