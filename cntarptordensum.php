...
$consulta = "SELECT * FROM vorden WHERE estado_ord=1 and edo_ord<>'PENDIENTE' and tipo_proy='3' ORDER BY folio_ord";
    ...
    <section class="content">
        ...
        <div class="card ">
            <div class="card-header bg-secondary">
                <h4 class="card-title text-center">ORDENES DE SUMINISTRO</h4>
            </div>
...
<script src="fjs/cntarptordensum.js"></script>
