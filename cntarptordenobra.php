...
$consulta = "SELECT * FROM vorden WHERE estado_ord=1 and edo_ord<>'PENDIENTE' and tipo_proy='2' ORDER BY folio_ord";
...
<script src="fjs/cntarptordenobra.js"></script>
