...
$consulta = "SELECT * FROM estante WHERE estado_estante=1 ORDER BY id_estante";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $dat['nom_estante'] ?></td>
                            ...
                            <div class="modal-body row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group input-group-sm">
                                        <label for="nombre" class="col-form-label">Estante:</label>
...
<script src="fjs/estante.js"></script>
