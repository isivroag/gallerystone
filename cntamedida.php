...
$consulta = "SELECT * FROM medida WHERE estado_medida=1 ORDER BY id_medida";
                            ...
                            <div class="table-responsive">
                                <table name="tablaV" id="tablaV" class="table table-sm table-striped table-bordered table-condensed text-nowrap w-auto mx-auto" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $dat['id_medida'] ?></td>
                                                <td><?php echo $dat['nom_medida'] ?></td>
...
<script src="fjs/medida.js?v=<?php echo(rand()); ?>"></script>
