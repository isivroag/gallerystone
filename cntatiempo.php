...
$fin = (isset($_GET['fin'])) ? $_GET['fin'] : '';
  ...
  $consulta = "SELECT * FROM vorden where avance=100 and estado_ord =1 and fecha_liberacion between '$inicio' and '$fin'";
//} else {
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="">
                        ...
                        <td class="text-center"><?php echo $dat['fecha_plantillad'] ?></td>
                        <td class="text-center"><?php echo $dat['fecha_liberacion'] ?></td>
                        <td class="text-center"><?php echo $dat['dias'] ?></td>
                      </tr>
                    <?php
                    }
                    ?>
...
<script src="fjs/cntatiempo.js?v=<?php echo (rand()); ?>"></script>
