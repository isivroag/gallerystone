...
if (isset($_GET['fechaini']) && isset($_GET['fechafin'])){
    ...
    $consulta = "SELECT * FROM mov_prod where estado_movp=1 AND id_mat='$id' and fecha_movp between '$fechaini' and '$fechafin' order by fecha_movp desc,id_movp desc";
}
else{
    $consulta = "SELECT * FROM mov_prod where estado_movp=1 AND id_mat='$id' order by fecha_movp desc,id_movp desc";
}
...
<script src="fjs/cntamovp.js?v=<?php echo (rand()); ?>"></script>
