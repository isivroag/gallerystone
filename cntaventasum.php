...
$consulta = "SELECT * FROM vventa WHERE estado_vta=1 and (saldo>0 or edo_orden<>'LIBERADO') and tipo_proy=3 ORDER BY folio_vta";
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-2">
                <div class="form-group input-group-sm">
                  ...
                  <input type="hidden" class="form-control" name="tipo_proy" id="tipo_proy" value=3>
                </div>
              </div>
