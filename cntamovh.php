...
if (isset($_GET['id'])) {
    ...
    echo "window.location='cntaherramienta.php'";
    echo "</script>";
}
...
foreach($data as $dr){
    $clave=$dr['id_her'];
    $descripcion=$dr['nom_her'];
    $cantidad=$dr['cant_her'];
    $material=$dr['nom_her'];
...
if (isset($_GET['fechaini']) && isset($_GET['fechafin'])){
    ...
    $consulta = "SELECT * FROM mov_herramienta where estado_movh=1 AND id_her='$id' and fecha_movh between '$fechaini' and '$fechafin' order by fecha_movh desc,id_movh desc";
}
else{
    $consulta = "SELECT * FROM mov_herramienta where estado_movh=1 AND id_her='$id' order by fecha_movh desc,id_movh desc";
}
                            ...
                            <div class="table-responsive">
                                <table name="tablaV" id="tablaV" class="table table-hover table-sm table-striped table-bordered table-condensed text-nowrap w-auto mx-auto" style="font-size:15px;">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $rowdata['id_movh'] ?></td>
                                                <td><?php echo $rowdata['fecha_movh'] ?></td>
                                                <td><?php echo $rowdata['tipo_movh'] ?></td>
...
<script src="fjs/cntamovh.js?v=<?php echo (rand()); ?>"></script>
