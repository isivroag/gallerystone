...
if ($folio != "") {
    ...
    if ($resultadotmp->rowCount() >= 1) {
        ...
        $fecha = date('Y-m-d');
        $consultatmp = "INSERT INTO cxp (tokenid,fecha,fecha_limite,tipo,subtotal,iva,total,saldo) VALUES('$tokenid','$fecha','$fecha','CXPINSUMODES','0','0','0','0')";
        $resultadotmp = $conexion->prepare($consultatmp);
        $resultadotmp->execute();
                            ...
                            <div class="col-lg-12 mx-auto">
                                ...
                                <div class="table-responsive" style="padding:5px;">
                                    ...
                                    <table name="tablaDetIndes" id="tablaDetIndes" class="table table-sm table-striped table-bordered table-condensed text-nowrap mx-auto" style="width:100%;font-size:15px">
                                        ...
                                        <tbody>
                                            <?php
                                            $consultadeto = "SELECT * FROM vdetallecxp_desechable where folio_cxp='$folio' and estado_reg=1 order by id_reg";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $rowdet['cant_des'] ?></td>
                                                    <td><?php echo $rowdet['costo_des'] ?></td>
...
<script src="fjs/compradesgaste.js?v=<?php echo (rand()); ?>"></script>
