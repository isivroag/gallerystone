		...
		<table id="factura_detalle">
			<thead class="">
				<tr>
					...
					<th class="textcenter" width="120px">Concepto</th>
					<th class="textcenter" width="180px">Material</th>
					<th class="textcenter" width="90px">Unidad</th>
					<th class="textcenter" width="110px">Precio Unitario</th>
					<th class="textcenter" width="110px"> Precio Total</th>
				</tr>
			</thead>
			<tbody id="detalle_productos" class="">
				<tr>
					...
					<td class="textright">$ 63,250.00</td>
				</tr>
				<tr>
					<td class="textcenter">115</td>
			...
			<tfoot id="">
				<tr>
					...
					<td class="textright"><span>$ 113,700.00</span></td>
				</tr>
				<tr>
					<td colspan="5" class="textright"><span>IVA (16%):</span></td>
					<td class="textright"><span>$ 18,192.00</span></td>
				</tr>
				<tr>
					<td colspan="5" class="textright"><span>TOTAL:</span></td>
					<td class="textright"><span>$ 131,892.00</span></td>
				</tr>
			</tfoot>
