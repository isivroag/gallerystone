...
$consulta = "SELECT * FROM vdesechable WHERE estado_des=1 and cant_des<= minimo ORDER BY id_des";
    ...
    <section class="content">
        ...
        <div class="card ">
            <div class="card-header bg-gradient-secondary text-light">
                <h1 class="card-title mx-auto">Insumos de Desgaste con Existencias Minimas</h1>
            </div>
...
<script src="fjs/reordeninsdes.js?v=<?php echo(rand()); ?>"></script>
