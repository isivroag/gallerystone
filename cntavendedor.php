...
$consulta = "SELECT * FROM vendedor WHERE estado_vend=1 ORDER BY id_vend";
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-gradient-orange text-light">
                <h1 class="card-title mx-auto">Vendedores</h1>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="help/vendedores/" target="_blank" rel="noopener"><button id="btnAyuda" type="button" class="btn bg-gradient-info btn-ms"><i class="fas fa-question-circle text-light"></i><span class="text-light"> Ayuda</span></button></a>
                    </div>
                </div>
                <br>
                            ...
                            <div class="table-responsive">
                                <table name="tablaV" id="tablaV" class="table table-sm table-striped table-bordered table-condensed text-nowrap w-auto mx-auto" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $dat['id_vend'] ?></td>
                                                <td><?php echo $dat['nom_vend'] ?></td>
...
<script src="fjs/cntavendedor.js"></script>
