...
$consulta = "SELECT * FROM vorden WHERE estado_ord=1 and edo_ord='CORTE' and  edo_ord<>'LIBERADO' and tipop='PROYECTO' ORDER BY folio_ord";
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <a href="help/pcorte/" target="_blank" rel="noopener"><button id="btnAyuda" type="button" class="btn bg-gradient-info btn-ms"><i class="fas fa-question-circle text-light"></i><span class="text-light"> Ayuda</span></button></a>
          </div>
        </div>
        <br>
...
<script src="fjs/cntacorte.js?v=<?php echo (rand()); ?>"></script>
