...
$consulta = "SELECT * FROM color WHERE estado_color=1 ORDER BY id_color";
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="help/color/" target="_blank" rel="noopener"><button id="btnAyuda" type="button" class="btn bg-gradient-info btn-ms"><i class="fas fa-question-circle text-light"></i><span class="text-light"> Ayuda</span></button></a>
                    </div>
                </div>
                <br>
